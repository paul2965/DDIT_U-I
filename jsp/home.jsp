    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <svg class="bd-placeholder-img" width="100%" height="100%" 
			...
			<img src="img/coco.jpg" class="bd-placeholder-img" alt="...">
        <div class="container">
...
<br>
	<div class="mt-5 row">
      <div class="col-lg-4">
        <img id="center" src="img/coco.jpg" class="bd-placeholder-img rounded-circle " width="140" height="140" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title></img>
    ...
    <div class="row featurette">
      ...
      <div class="col-md-5">
        <img id="center" src="img/kimin.jpg" class="bd-placeholder-img rounded-circle" width="500" height="500" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 500x500" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title></img>
      </div>
     <hr>
    <div class="row featurette">
      <div class="col-md-7">
      ...
      <div class="col-md-5">
        <img id="center" src="img/yun.jpg" class="bd-placeholder-img rounded-circle" width="500" height="500" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 500x500" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title></img>
      </div>
	<hr>
    <div class="row featurette">
      <div class="col-md-7">
      ...
      <div class="col-md-5">
        <img id="center" src="img/sang.jpg" class="bd-placeholder-img rounded-circle" width="500" height="500" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 500x500" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title></img>
      </div>
    </div>
