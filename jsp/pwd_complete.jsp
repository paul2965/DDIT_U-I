...
<html lang="en">
  ...
  <body>
    ...
    <div class="container h3 mb-3 fw-normal border border-1"  id="div01" >
        ...
        <div class=" form-signin border border-1">
        <h2 class="form-signin-heading" >비밀번호 찾기 완료</h2>
        <h2 class="form-signin-heading" ></h2>
        <label for="inputname" class="sr-only"></label>
        <input type="text" id="inputname" class="form-control" placeholder="임시 비밀번호" required autofocus>
