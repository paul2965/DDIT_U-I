	...
	<div id="container">
		...
		<div id="malePicture"></div>
			...
			<div class="items-container">
				...
				<div class="items">
					<input type="checkbox" id="look1" class="look" name="look"> <label for="look1">훈훈한</label>
					<input type="checkbox" id="look2" class="look" name="look"> <label for="look2">착하게 생긴</label>
					<input type="checkbox" id="look3" class="look" name="look"> <label for="look3">귀여운</label>
					<input type="checkbox" id="look4" class="look" name="look"> <label for="look4">보조개</label>
					<input type="checkbox" id="look5" class="look" name="look"> <label for="look5">개성있는</label>
					<input type="checkbox" id="look6" class="look" name="look"> <label for="look6">패셔너블한</label>
					<input type="checkbox" id="look7" class="look" name="look"> <label for="look7">조각미남</label>
			...
			<div class="items-container">
				...
				<div class="items">
					<input type="checkbox" id="body1" class="body" name="body"> <label for="body1">넓은 어깨</label>
					<input type="checkbox" id="body2" class="body" name="body"> <label for="body2">듬직한</label>
					<input type="checkbox" id="body3" class="body" name="body"> <label for="body3">슬림한</label>
					<input type="checkbox" id="body4" class="body" name="body"> <label for="body4">근육이 많은</label>
					...
					<input type="checkbox" id="body7" class="body" name="body"> <label for="body7">보통</label>
				</div>
			</div>
			*각 항목당 1~2개 선택가능.
			<hr>
			...
			<input type="checkbox" id="personality5" class="personality" name="personality"> <label for="personality5">사교적인</label>
